(function () {
  ...
  var SKETCH_VERSION = '26'; // Northern Cardinal flight illustration.
  ...
  var IMG_VERSION = '19'; // Northern Cardinal flight illustration.
  ...
  function renderAdminReview() {
    ...
    adminBody.innerHTML =
      ...
      + '  <input id="reviewQuery" type="search" value="House Sparrow" placeholder="House Sparrow or blank for all birds">'
